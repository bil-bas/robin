...
describe "/players route" do
  ...
  describe "POST /players" do
    should "create a new game and return a new id" do   
      ...
      Robin::Models::Player.count.should.equal 3
      Robin::Models::Player.where(username: "cheese").first.email.should.equal "fish@frog.com"
    end
    ...
    should "fail if a player of that name already exists" do     
      ...
      Robin::Models::Player.count.should.equal 2
    end 
  end
end